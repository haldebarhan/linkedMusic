...
export const ENV = {
  ...
  JEKO_WEBHOOK_URL: getEnv("JEKO_WEBHOOK_URL", true),
  JEKO_STORE_ID: getEnv("JEKO_STORE_ID", true),
  JEKO_BASE_URL: getEnv("JEKO_BASE_URL", true),
  JEKO_WEBHOOK_SECRET: getEnv("JEKO_WEBHOOK_SECRET", true),
};
